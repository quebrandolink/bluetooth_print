...
/// Estado do adaptador Bluetooth e da conexão com a impressora.
enum BluetoothPrintStatus {
  /// Adaptador ligado e operacional.
  on,

  /// Adaptador desligado.
  off,

  /// Adaptador em processo de ativação.
  turningOn,

  /// Adaptador em processo de desativação.
  turningOff,
  ...
  /// Estado não mapeado pela plataforma.
  unknown,
}
